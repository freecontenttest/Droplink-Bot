...
const getCaption = (shortenLink, BACKUP_CHANNEL, isScreenshot=false) => {
    ...
    let URL_CAPTION = `❓️ _How To Download From ${isDropLink ? 'DROPLINK' : 'PDISKLINK'}_\n          _(${isDropLink ? 'DropLink' : 'PdiskLink'} से वीडियो कैसे डाउनलोड करे)_ 👇🏻️\n➤ https://t.me/how\\_to\\_download\\_movie\\_official/${isDropLink ? 4 : 8}\n\n\n🎬 *Video Link*\n ➪ ${shortenLink}\n\n\n`;
